...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.34.0/darwin-thread-multi-2level'),
    ...
    libpth => '/private/Users/kumarvinayak/health_monitor/venv/lib/clang/12.0.0/lib /opt/MacOSX10.14.sdk/usr/lib',
    osname => 'darwin',
    osvers => '20.6.0',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.34.0'),
    scriptdir => '.../',
    sitearchexp => relocate_inc('.../../lib/site_perl/5.34.0/darwin-thread-multi-2level'),
